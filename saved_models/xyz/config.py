...
num_processes = int(1) # how many training CPU processes to use (default: 16)
...
log_interval = int(1)  # log interval, one log per n updates (default: 10)'
save_interval = 1 # save interval, one save per n updates (default: 100)
...
num_env_steps = 10e2 # number of environment steps to train (default: 10e6)

num_mini_batch = int(8) # number of batches for ppo (default: 32)
